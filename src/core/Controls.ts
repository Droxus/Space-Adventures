...
export class Controls {
    ...
    public makeObjectMove(params: {obj: THREE.Object3D, diffPosition: {x: number, y: number, z: number}}){
        this.translateCameraTo({ x: params.diffPosition.x * this.controlsSpeed})
        this.translateCameraTo({ y: params.diffPosition.y * this.controlsSpeed})
        this.translateCameraTo({ z: params.diffPosition.z * this.controlsSpeed})
